  ...
  Widget build(BuildContext context) {
    var photo = Container(
      ...
      child: (_photo == null)
          ...
          : Image.asset('images/default.jpg'), //Image.asset(_photo as String),
      //-> default.jpg외에 다른 사진들이 문제인 것 같아 임의로 지정함.
    );
...
Map<int, Map<String, String>> users = {
  0x0000: {'name': '손승표', 'photo': 'SSP.jpg'},
  0x0001: {'name': '정동원', 'photo': 'JDW.jpg'},
  0x0002: {'name': '황서진', 'photo': 'HSJ.jpg'},
};
